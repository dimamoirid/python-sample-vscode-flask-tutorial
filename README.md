[![Build Status](https://dev.azure.com/damoirid/project%201/_apis/build/status/dimamoirid.python-sample-vscode-flask-tutorial?branchName=master)](https://dev.azure.com/damoirid/project%201/_build/latest?definitionId=1&branchName=master)
